...
<body>
<?php include('admin-php/handle-login.php');
...
<div class="container-fluid">
  <div class="row main-content text-center">
    <div class="col-12 col-md-6 pt-3 text-center company__info">
      <span class="company__logo"><img src="../figures/shop.jpg" alt="image"></span>
      <h4 class="company_title">Salón-Vivien</h4>
    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <form class="form-group" action="" method="post">
            ...
            <div class="row">
              <input class="form__input" id="password" name="password" placeholder="Heslo" type="password">
            </div>
            <div class="row">
              <input class="btn" type="submit" value="Prihlásiť sa">
            </div>
          </form>
            <?php if(isset($_SESSION['error-login']) && $_SESSION['error-login']) { ?>
