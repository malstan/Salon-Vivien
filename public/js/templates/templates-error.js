 ...
 * Stanislav Malik
 * 2021
 * templates for errors, preparing content page
 */

/**
 * error page with space animation and some info about error
 * @returns {string} - html template of error page
 */
export const errorDresses = () => {
    return (`
    <main>
      <div class="container">
        <div class="row">
    ...
    <!-- info about error -->
          <div class="col-md-6 align-self-center">
            <h1>UH OH! Niekde je chyba.</h1>
            <p>Stránka, ktorú hľadáte neexistuje alebo máme v systéme chybu.</p>
            <p>{{error}}</p>
            <br>
            <a class="error-link me-2" onclick="window.location.reload()">Skúsiť znovu</a>
            <a class="error-link" href="#home">Domov</a>
          </div>
        </div>
      </div>
    </main>
...
/**
 * preparing content page
 * @returns {string} - html template for preparing content page
 */
export const preparing = () => {
    ...
    <!-- animation -->
            <div class="col-lg-6 mb-5">
              <div class="row">
                <div class="col">
                    <span id="wrench" class="fas fa-wrench fa-7x"></span>
                    <span id="cog" class="fas fa-cog fa-5x"></span>
                </div>
                <div class="col"></div>
              </div>
              <div class="row">
                <div class="col"></div>
                <div class="col">
                  <span id="hammer" class="fas fa-hammer fa-5x"></span>
                  <span id="house" class="fas fa-home fa-7x"></span>
                </div>
              </div> 
            </div>
    <!-- info -->
            <div class="col-lg-6 align-self-center">
              <h1>Obsah pripravujeme.</h1>
              <p>Onedlho tu nájdete čo hľadáte.</p>
            </div>
          </div>
        </div>
      </div>
